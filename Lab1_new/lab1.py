...
class Node:
    ...
    #to compare elevations of two points
    def __lt__(self, other):
        return self.elevation < other.elevation

    #to compare nodes if the f values are equal
        ...
        for y in range(cols):
            ...
            if (current_node_color[0] == 0 and current_node_color[1] == 0 and current_node_color[2] == 255):
                ...
                for neighbor in neighbors:
                    x1,y1 =neighbor
                    if(x1<rows and x1>=0 and y1<cols and y1>=0 and neighbor not in edgelist):
            ...
            if season == "fall":
                ...
                for neighbor2 in neighbors2:
                    ...
                    if neighbor2_color[0] == 255 and neighbor2_color[1] == 255 and neighbor2_color[2] == 255:
                        mult_factor = checkterraintype(terraincolor) * 1.3
